...
public class ModRecipes {
    ...
    public static final Supplier<CodecRecipeType<CuttingBoardRecipe>> CUTTING_BOARD_RECIPE = registerCodec("cutting_board");
    ...
    private static <T extends CodecRecipe<?>> Supplier<CodecRecipeType<T>> registerCodec(String id) {
        return registerType(id, () -> CodecRecipeType.of(id));
    }
