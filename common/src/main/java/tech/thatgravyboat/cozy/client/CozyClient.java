...
public class CozyClient {
    ...
    public static void initRenderTypes() {
        ...
        setRenderType(ModBlocks.BLACK_LAMP.get(), RenderType.cutout());
        setRenderType(ModBlocks.BLUE_LAMP.get(), RenderType.cutout());
        setRenderType(ModBlocks.BROWN_LAMP.get(), RenderType.cutout());
        setRenderType(ModBlocks.CYAN_LAMP.get(), RenderType.cutout());
        setRenderType(ModBlocks.GRAY_LAMP.get(), RenderType.cutout());
        setRenderType(ModBlocks.GREEN_LAMP.get(), RenderType.cutout());
        setRenderType(ModBlocks.LIGHT_BLUE_LAMP.get(), RenderType.cutout());
        setRenderType(ModBlocks.LIGHT_GRAY_LAMP.get(), RenderType.cutout());
        setRenderType(ModBlocks.LIME_LAMP.get(), RenderType.cutout());
        setRenderType(ModBlocks.MAGENTA_LAMP.get(), RenderType.cutout());
        setRenderType(ModBlocks.ORANGE_LAMP.get(), RenderType.cutout());
        setRenderType(ModBlocks.PINK_LAMP.get(), RenderType.cutout());
        setRenderType(ModBlocks.PURPLE_LAMP.get(), RenderType.cutout());
        setRenderType(ModBlocks.RED_LAMP.get(), RenderType.cutout());
        setRenderType(ModBlocks.WHITE_LAMP.get(), RenderType.cutout());
        setRenderType(ModBlocks.YELLOW_LAMP.get(), RenderType.cutout());
